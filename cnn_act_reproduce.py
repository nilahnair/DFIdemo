...
ex = Experiment('MotionSense - ICPR2024 - Reproduce Act Network Results')
# Create MongoObserver and append it to ex.observers
ex.observers.append(create_observer())
@ex.config
def reproduce_act_network_config():
    network_path = '/home/thallybu/ICPR_2024_IMU_AnonGAN/code/model/cnn_motionsense_act.pt' 

@ex.automain
def reproduce_act_network(network_path):
